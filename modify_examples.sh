...
echo $'18. Calling sed\n';
#./modifytest.sh "s/\b\(.\)/\u\1/g";
echo $'19. Calling sed with directory\n';
#./modifytest.sh "s/\b\(.\)/\u\1/g" $PWD/extra;
echo $'20. Calling sed with path\n';
#./modifytest.sh "s/\b\(.\)/\u\1/g" $PWD/extra/testfile.txt;
...
#./modifytest.sh "s/\b\(.\)/\u\1/g" $PWD/dir;
echo $'27. Calling sed and an additional sed\n';
#./modifytest.sh "s/\b\(.\)/\u\1/g" "s/\b\(.\)/\u\1/g";
